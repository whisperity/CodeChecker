...
def upgrade():
    ...
    try:
        ...
        if dialect == 'sqlite':
            ...
            # (it will create a new database) but it will clear the table
            # which have foreign keys with cascade delete property.
            # Unfortunately, disabling the pragma foreign key doesn't work
            # here. For this reason we will keep these columns in case of
            # SQLite.
